            ...
            <?php foreach ($all_suppliers as $supplier):?>
              <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <a href="edit_supplier.php?supplier_id=<?php echo (int)$supplier['supplier_id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                        <span class="glyphicon glyphicon-edit"></span>
                      </a>
                      <a href="delete_supplier.php?supplier_id=<?php echo (int)$supplier['supplier_id'];?>"  class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">
